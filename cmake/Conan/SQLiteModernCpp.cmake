...
execute_process(
    COMMAND ${CMAKE_COMMAND} "${CMAKE_CURRENT_LIST_DIR}/SQLiteModernCpp" -DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_FILE} -DCMAKE_CXX_FLAGS=${PROPAGATED_CXX_FLAGS} -DCMAKE_C_FLAGS=${PROPAGATED_C_FLAGS} -DCMAKE_EXE_LINKER_FLAGS=${PROPAGATED_EXE_LINKER_FLAGS} -DCMAKE_SHARED_LINKER_FLAGS=${PROPAGATED_SHARED_LINKER_FLAGS} -DGITHUB_HOST=${SQLITE_GITHUB_HOST}
